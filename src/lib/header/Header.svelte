				...
				<li class:active={$page.url.pathname === '/'}>
					<a aria-label="hjem" sveltekit:prefetch href="/"
						><svg
							...
							><path
								class="b"
								d="M527.16,365.05c-7.33-4.32-10.56-9.08-12.15-12.63-1.5-3.35-2.17-9.5-3.51-21.79-.21-1.88-.71-6.69-2.71-12.65-.38-1.14-.74-2.06-.98-2.68-2.58-3.91-8.29-11.36-18.35-16.5-14.68-7.5-28.66-5-32.91-4.07,1.54,.64,5.31,2.46,7.98,6.65,3.94,6.19,2.37,12.72,2.07,13.89-.38,4.44-.57,9.37-.41,14.7,.26,8.33,1.32,15.71,2.62,21.94,.97,2.22,7.37,16.2,23.19,21.27,0,0,14.02,4.49,29.25-2.66,2.18-1.02,3.69-2.51,3.69-2.51,1.09-1.07,1.78-2.16,2.22-2.95Z"
							/><path
								class="b"
...
<style>
	...
	.menu__box {
		...
		padding: 0;
		list-style: none;
		background-color: rgb(93, 148, 180);
